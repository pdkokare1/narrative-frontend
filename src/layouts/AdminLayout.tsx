...
const Icons = {
  ...
  // NEW ICON for Narratives (using a 'Collection' style icon)
  Narratives: () => <svg style={{width:'20px', height:'20px'}} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>,
    ...
    <div className="admin-container">
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="admin-nav">
          ...
          {/* NEW NARRATIVES LINK */}
          <NavLink to="/admin/narratives" onClick={() => setSidebarOpen(false)} className={({ isActive }) => `admin-nav-item ${isActive ? 'active' : ''}`}>
            <Icons.Narratives /> <span>Narratives</span>
          </NavLink>
