...
export const VOICE_ASSETS: IVoiceAssets = {
  ...
  OPENERS: {
    MIRA: {
      MORNING: [
        `${CLOUD_BASE}/mira_open_morn_1.mp3`, `${CLOUD_BASE}/mira_open_morn_2.mp3`, `${CLOUD_BASE}/mira_open_morn_3.mp3`
      ],
      AFTERNOON: [
        `${CLOUD_BASE}/mira_open_aft_1.mp3`, `${CLOUD_BASE}/mira_open_aft_2.mp3`, `${CLOUD_BASE}/mira_open_aft_3.mp3`
      ],
      EVENING: [
        `${CLOUD_BASE}/mira_open_eve_1.mp3`, `${CLOUD_BASE}/mira_open_eve_2.mp3`, `${CLOUD_BASE}/mira_open_eve_3.mp3`
      ]
    },
    RAJAT: {
      MORNING: [
        `${CLOUD_BASE}/rajat_open_morn_1.mp3`, `${CLOUD_BASE}/rajat_open_morn_2.mp3`, `${CLOUD_BASE}/rajat_open_morn_3.mp3`
      ],
      AFTERNOON: [
        `${CLOUD_BASE}/rajat_open_aft_1.mp3`, `${CLOUD_BASE}/rajat_open_aft_2.mp3`, `${CLOUD_BASE}/rajat_open_aft_3.mp3`
      ],
      EVENING: [
        `${CLOUD_BASE}/rajat_open_eve_1.mp3`, `${CLOUD_BASE}/rajat_open_eve_2.mp3`, `${CLOUD_BASE}/rajat_open_eve_3.mp3`
      ]
    },
    SHUBHI: {
      MORNING: [
        `${CLOUD_BASE}/shubhi_open_morn_1.mp3`, `${CLOUD_BASE}/shubhi_open_morn_2.mp3`, `${CLOUD_BASE}/shubhi_open_morn_3.mp3`
      ],
      AFTERNOON: [
        `${CLOUD_BASE}/shubhi_open_aft_1.mp3`, `${CLOUD_BASE}/shubhi_open_aft_2.mp3`, `${CLOUD_BASE}/shubhi_open_aft_3.mp3`
      ],
      EVENING: [
        `${CLOUD_BASE}/shubhi_open_eve_1.mp3`, `${CLOUD_BASE}/shubhi_open_eve_2.mp3`, `${CLOUD_BASE}/shubhi_open_eve_3.mp3`
      ]
    }
  },

  // --- SEGUES (Same Host Transitions) ---
  SEGUES: {
    MIRA: [
